        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex ms-2 md:me-24">
                    <img src="images/reshot-icon-lastfm-NVQ647DYCA.svg" class="h-8 me-3" alt="Logo" />
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">News App</span>
                </a>
            </div>
